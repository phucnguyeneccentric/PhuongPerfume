<%-- 
    Document   : dau-trang
    Created on : Apr 10, 2017, 10:08:03 AM
    Author     : hv
--%>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="trang-gio-hang.jsp">Giỏ hàng - <span class="cart-amunt">${sessionScope.gioHang.TongTien()}</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                    </div>
                </div>
            </div>
        </div>
